...
const routes: Routes = [
  ...
  {path: 'home', component: HomeComponent, canActivate: [AuthGuard], children: [
    ...
    { path: 'addict', children: [
      {path: 'addict', component: AddictComponent, canActivate: [AuthGuard]},    
      {path: 'addict-place', component: AddictPlaceComponent, canActivate: [AuthGuard]},
      {path: 'addict-drug', component: AddictDrugComponent, canActivate: [AuthGuard]},
      {path: 'addict-search', component: AddictSearchComponent, canActivate: [AuthGuard]},    
      {path: 'addict-classify', component: AddictclassifyComponent, canActivate: [AuthGuard]},
      {path: 'addict-move', component: MoveHistoryComponent, canActivate: [AuthGuard]}, 
   ]},
     {path: 'category', children: [    
      {path: 'drugs', component: DrugsComponent, canActivate: [AuthGuard] },
      {path: 'manageplace', component: ManageplaceComponent, canActivate: [AuthGuard]},
      {path: 'classify', component: ClassifyComponent, canActivate: [AuthGuard]},
      {path: 'edulevel', component: EdulevelComponent, canActivate: [AuthGuard]}  
  ]}, 
